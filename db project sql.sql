...
(1001, 1001, 4.58, 2.29, 48.09),
(1002, 1002, 15.00, 7.50, 157.50),
(1003, 1003, 13.50, 6.75, 141.75),
(1004, 1004, 7.00, 3.50, 73.50),
(1005, 1005, 12.00, 6.00, 126.00),
(1006, 1006, 4.00, 2.00, 42.00),
(1007, 1007, 3.60, 1.80, 37.80),
(1008, 1008, 8.00, 4.00, 84.00),
(1009, 1009, 10.00, 5.00, 105.00),
(1010, 1010, 9.00, 4.50, 94.50);
...
BEGIN
    ...
    -- Calculate total price of medicines for the prescription
    ...
    -- Handle case if no medicines are found
    ...
    ELSE
        -- Insert new bill (bill_id = prescription_id for simplicity)
